              ...
              <div className="space-y-5 sm:space-y-6">
                <div className="flex items-start gap-4 p-3.5 sm:p-4 rounded-xl border border-slate-200 bg-white shadow-sm">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] sm:text-xs text-slate-800 font-sans-modern font-semibold leading-relaxed">
                ...
                <div className="flex items-start gap-4 p-3.5 sm:p-4 rounded-xl border border-slate-200 bg-white shadow-sm">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${settings?.contactEmail || "info@ikc.org.in"}`} className="text-[11px] sm:text-xs text-teal-700 hover:text-teal-800 font-semibold font-sans-modern transition-colors">
                ...
                <div className="flex items-start gap-4 p-3.5 sm:p-4 rounded-xl border border-slate-200 bg-white shadow-sm">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] sm:text-xs text-slate-800 font-sans-modern font-semibold">
                ...
                <div className="flex items-start gap-4 p-3.5 sm:p-4 rounded-xl border border-slate-200 bg-white shadow-sm">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] sm:text-xs text-slate-850 font-sans-modern font-medium">
      ...
      <section className="py-10 md:py-16 px-4 sm:px-6 lg:px-8 w-full">
        <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-12">
          <FadeIn direction="down">
            ...
            <h2 className="text-xl sm:text-2xl lg:text-3xl font-extrabold tracking-tight text-slate-900 font-display mb-4">
              Common Questions
            </h2>
          </FadeIn>
        </div>
          ...
          {faqs.map((faq: FaqItem, idx: number) => (
            <StaggerItem key={idx} className="bg-white border border-slate-200 rounded-2xl p-5 sm:p-6 shadow-sm">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-xs sm:text-sm font-bold text-slate-900 font-display mb-2">{faq.q}</h3>
                  <p className="text-[11px] sm:text-xs text-slate-500 leading-relaxed font-sans-modern">{faq.a}</p>
                </div>
              </div>
            </StaggerItem>
          ))}
